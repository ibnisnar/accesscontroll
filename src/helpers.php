...
if (! function_exists('setPermissionsTeamId')) {
    ...
    {
        app(\Ibnisnar\Accesscontroll\PermissionRegistrar::class)->setPermissionsTeamId($id);
    }
}
...
if (! function_exists('getPermissionsTeamId')) {
    ...
    {
        return app(\Ibnisnar\Accesscontroll\PermissionRegistrar::class)->getPermissionsTeamId();
    }
}
